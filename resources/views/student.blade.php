                ...
                <div class="card lg-3">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('/update/'.$student->id) }}" method="post">
                            ...
                            <div class="form-group">
                                <label>First Name</label>
                                <input pattern="[A-Za-z] value=" {{ $student->firstName }}" name="firstName" type="text" class="form-control" placeholder="Enter First Name" required>
                            </div>
                            <div class="form-group">
                                <label>Last Name</label>
                                <input pattern="[A-Za-z -] value=" {{ $student->lastName }}" name="lastName" type="text" class="form-control" placeholder="Enter Last Name" required>
                            </div>
                            <div class="form-group">
                                <label>Age</label>
                            ...
                            <div class="form-group">
                                <label>Speciality</label>
                                <input pattern="[A-Za-z -]" value=" {{ $student->speciality }}" name="speciality" type="text" class="form-control" placeholder="Enter Speciality" required>
                            </div>
